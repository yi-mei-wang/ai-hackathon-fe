...
$jscomp.initSymbolIterator = function() { $jscomp.initSymbol(); var d = $jscomp.global.Symbol.iterator;
    d || (d = $jscomp.global.Symbol.iterator = $jscomp.global.Symbol("iterator")); "function" != typeof Array.prototype[d] && $jscomp.defineProperty(Array.prototype, d, { configurable: !0, writable: !0, value: function() { return $jscomp.arrayIterator(this) } });
...
$jscomp.iteratorPrototype = function(d) { $jscomp.initSymbolIterator();
    d = { next: d };
    d[$jscomp.global.Symbol.iterator] = function() { return this }; return d };
$jscomp.makeIterator = function(d) { $jscomp.initSymbolIterator();
    $jscomp.initSymbol();
    $jscomp.initSymbolIterator(); var c = d[Symbol.iterator]; return c ? c.call(d) : $jscomp.arrayIterator(d) };
$jscomp.polyfill = function(d, c, a, b) { if (c) { a = $jscomp.global;
        d = d.split("."); for (b = 0; b < d.length - 1; b++) { var e = d[b];
            e in a || (a[e] = {});
            a = a[e] }
        d = d[d.length - 1];
        b = a[d];
...
$jscomp.polyfill("Promise", function(d) {
    ...
    c.prototype.asyncExecute = function(a) { null == this.batch_ && (this.batch_ = [], this.asyncExecuteBatch_());
        this.batch_.push(a); return this };
    c.prototype.asyncExecuteBatch_ = function() { var a = this;
    ...
    c.prototype.executeBatch_ = function() { for (; this.batch_ && this.batch_.length;) { var a = this.batch_;
            this.batch_ = []; for (var b = 0; b < a.length; ++b) { var c = a[b];
                delete a[b]; try { c() } catch (m) { this.asyncThrow_(m) } } }
        this.batch_ = null };
    c.prototype.asyncThrow_ = function(a) { this.asyncExecuteFunction(function() { throw a; }) };
    var e = function(a) { this.state_ = 0;
        this.result_ = void 0;
        this.onSettledCallbacks_ = []; var b = this.createResolveAndReject_(); try { a(b.resolve, b.reject) } catch (l) { b.reject(l) } };
    e.prototype.createResolveAndReject_ =
        function() {
            function a(a) { return function(h) { c || (c = !0, a.call(b, h)) } } var b = this,
                c = !1; return { resolve: a(this.resolveTo_), reject: a(this.reject_) } };
    ...
    e.all = function(b) { var c = $jscomp.makeIterator(b),
            d = c.next(); return d.done ? a([]) : new e(function(b, e) {
            function k(a) { return function(c) { h[a] = c;
                    f--;
                    0 == f && b(h) } } var h = [],
                f = 0;
...
$jscomp.executeAsyncGenerator = function(d) {
    ...
    function a(a) { return d.throw(a) } return new Promise(function(b, e) {
...
$jscomp.inherits = function(d, c) {
    ...
    d.prototype = new a;
    d.prototype.constructor = d; for (var b in c)
        if ("prototype" != b)
            if (Object.defineProperties) { var e = Object.getOwnPropertyDescriptor(c, b);
                e && Object.defineProperty(d, b, e) } else d[b] = c[b] };
$jscomp.iteratorFromArray = function(d, c) { $jscomp.initSymbolIterator();
    d instanceof String && (d += ""); var a = 0,
        b = { next: function() { if (a < d.length) { var e = a++; return { value: c(e, d[e]), done: !1 } }
                b.next = function() { return { done: !0, value: void 0 } }; return b.next() } };
    b[Symbol.iterator] = function() { return b }; return b };
...
$jscomp.polyfill("WeakMap", function(d) {
    ...
    function a(a) { var b = Object[a];
        b && (Object[a] = function(a) { c(a); return b(a) }) }
    if (function() { if (!d || !Object.seal) return !1; try { var a = Object.seal({}),
                    b = Object.seal({}),
                    c = new d([
                        [a, 2],
                        [b, 3]
                ...
                c.delete(a);
                c.set(b, 4); return !c.has(a) && 4 == c.get(b) } catch (m) { return !1 } }()) return d;
    var b = "$jscomp_hidden_" + Math.random().toString().substring(2);
    a("freeze");
    a("preventExtensions");
    a("seal");
    var e = 0,
        f = function(a) { this.id_ = (e += Math.random() + 1).toString(); if (a) { $jscomp.initSymbol();
                $jscomp.initSymbolIterator();
                a = $jscomp.makeIterator(a); for (var b; !(b = a.next()).done;) b = b.value, this.set(b[0], b[1]) } };
    f.prototype.set = function(a, d) { c(a); if (!$jscomp.owns(a, b)) throw Error("WeakMap key fail: " + a);
        a[b][this.id_] = d; return this };
...
$jscomp.polyfill("Map", function(d) {
    if (!$jscomp.ASSUME_NO_NATIVE_MAP && function() { if (!d || !d.prototype.entries || "function" != typeof Object.seal) return !1; try { var a = Object.seal({ x: 4 }),
                    b = new d($jscomp.makeIterator([
                        [a, "s"]
                    ])); if ("s" != b.get(a) || 1 != b.size || b.get({ x: 4 }) || b.set({ x: 4 }, "t") != b || 2 != b.size) return !1; var c = b.entries(),
                    e = c.next(); if (e.done || e.value[0] != a || "s" != e.value[1]) return !1;
                e = c.next(); return e.done || 4 != e.value[0].x || "t" != e.value[1] || !c.next().done ? !1 : !0 } catch (v) { return !1 } }()) return d;
    $jscomp.initSymbol();
    $jscomp.initSymbolIterator();
    var c = new WeakMap,
        a = function(a) { this.data_ = {};
            this.head_ = f();
            this.size = 0; if (a) { a = $jscomp.makeIterator(a); for (var b; !(b = a.next()).done;) b = b.value, this.set(b[0], b[1]) } };
    a.prototype.set = function(a, c) { var d = b(this, a);
        d.list || (d.list = this.data_[d.id] = []);
        d.entry ? d.entry.value = c : (d.entry = { next: this.head_, previous: this.head_.previous, head: this.head_, key: a, value: c }, d.list.push(d.entry), this.head_.previous.next = d.entry, this.head_.previous = d.entry, this.size++); return this };
    a.prototype.delete =
    ...
    a.prototype.clear = function() { this.data_ = {};
    ...
    var b = function(a, b) {
        ...
        e = function(a, b) { var c = a.head_; return $jscomp.iteratorPrototype(function() { if (c) { for (; c.head != a.head_;) c = c.previous; for (; c.next != c.head;) return c = c.next, { done: !1, value: b(c) };
...
$jscomp.polyfill("Set", function(d) {
    if (!$jscomp.ASSUME_NO_NATIVE_SET && function() { if (!d || !d.prototype.entries || "function" != typeof Object.seal) return !1; try { var a = Object.seal({ x: 4 }),
                    b = new d($jscomp.makeIterator([a])); if (!b.has(a) || 1 != b.size || b.add(a) != b || 1 != b.size || b.add({ x: 4 }) != b || 2 != b.size) return !1; var c = b.entries(),
                    f = c.next(); if (f.done || f.value[0] != a || f.value[1] != a) return !1;
                f = c.next(); return f.done || f.value[0] == a || 4 != f.value[0].x || f.value[1] != f.value[0] ? !1 : c.next().done } catch (h) { return !1 } }()) return d;
    $jscomp.initSymbol();
    $jscomp.initSymbolIterator();
    var c = function(a) { this.map_ = new Map; if (a) { a = $jscomp.makeIterator(a); for (var b; !(b = a.next()).done;) this.add(b.value) }
        this.size = this.map_.size };
    c.prototype.add = function(a) { this.map_.set(a, a);
        this.size = this.map_.size; return this };
    c.prototype.delete = function(a) { a = this.map_.delete(a);
        this.size = this.map_.size; return a };
    c.prototype.clear = function() { this.map_.clear();
        this.size = 0 };
    ...
    c.prototype.forEach = function(a, b) { var c = this;
        this.map_.forEach(function(d) { return a.call(b, d, d, c) }) };
    return c
}, "es6", "es3");
$jscomp.polyfill("Object.assign", function(d) { return d ? d : function(c, a) { for (var b = 1; b < arguments.length; b++) { var d = arguments[b]; if (d)
                for (var f in d) $jscomp.owns(d, f) && (c[f] = d[f]) } return c } }, "es6", "es3");
$jscomp.polyfill("Array.from", function(d) { return d ? d : function(c, a, b) { $jscomp.initSymbolIterator();
        a = null != a ? a : function(a) { return a }; var d = [],
            f = c[Symbol.iterator]; if ("function" == typeof f)
            for (c = f.call(c); !(f = c.next()).done;) d.push(a.call(b, f.value));
        else { f = c.length; for (var h = 0; h < f; h++) d.push(a.call(b, c[h])) } return d } }, "es6", "es3");
...
(function(d) {
    function c(b) { if (a[b]) return a[b].exports; var e = a[b] = { i: b, l: !1, exports: {} };
        d[b].call(e.exports, e, e.exports, c);
        e.l = !0; return e.exports } var a = {};
    c.m = d;
    c.c = a;
    c.d = function(a, d, f) { c.o(a, d) || Object.defineProperty(a, d, { configurable: !1, enumerable: !0, get: f }) };
    c.n = function(a) { var b = a && a.__esModule ? function() { return a["default"] } : function() { return a };
        c.d(b, "a", b); return b };
    c.o = function(a, c) { return Object.prototype.hasOwnProperty.call(a, c) };
    c.p = "dist"; return c(c.s = 10) })([function(d, c, a) {
    a.d(c, "B",
        function() { return "df-messenger" });
    a.d(c, "C", function() { return "df-messenger-chat" });
    a.d(c, "A", function() { return "df-message-list" });
    a.d(c, "G", function() { return "df-messenger-user-input" });
    a.d(c, "H", function() { return "df-title" });
    a.d(c, "s", function() { return "df-button" });
    a.d(c, "r", function() { return "df-accordion" });
    a.d(c, "v", function() { return "df-chips" });
    a.d(c, "_0", function() { return "df-chip-clicked" });
    a.d(c, "o", function() { return "df-chips-wrapper" });
    a.d(c, "L", function() { return "expand" });
    a.d(c, "j", function() { return "chat-min" });
    a.d(c, "n", function() { return "chat-wrapper" });
    a.d(c, "a", function() { return "access-token" });
    a.d(c, "Y", function() { return "session-id" });
    a.d(c, "P", function() { return "language-code" });
    a.d(c, "e", function() { return "api-uri" });
    a.d(c, "d", function() { return "agent-id" });
    a.d(c, "V", function() { return "project-id" });
    a.d(c, "T", function() { return "message-list-wrapper" });
    a.d(c, "S", function() { return "minimized" });
    a.d(c, "O", function() { return "intent" });
    a.d(c, "p", function() { return "closeIcon" });
    a.d(c, "J", function() { return "dismissIcon" });
    a.d(c, "_1", function() { return "title-card-elements" });
    a.d(c, "Q", function() { return "link-wrapper" });
    ...
    a.d(c, "F", function() { return "df-messenger-titlebar" });
    a.d(c, "D", function() { return "df-messenger-error" });
    a.d(c, "W", function() { return "df-request-sent" });
    a.d(c, "X", function() { return "df-response-received" });
    a.d(c, "_3", function() { return "df-user-input-entered" });
    a.d(c,
        "M",
        function() { return "df-info-card-clicked" });
    a.d(c, "Z", function() { return "show" });
    a.d(c, "f", function() { return "typing" });
    a.d(c, "K", function() { return "error" });
    a.d(c, "U", function() { return "minimizeIcon" });
    a.d(c, "y", function() { return "df-image" });
    a.d(c, "g", function() { return "df-button-clicked" });
    a.d(c, "N", function() { return b });
    a.d(c, "z", function() { return "df-list-element" });
    a.d(c, "R", function() { return "df-list-element-clicked" });
    ...
    a.d(c, "I", function() { return "dfTitlebar" });
    ...
    a.d(c, "E", function() { return "df-messenger-loaded" });
    a.d(c, "_2", function() { return "user-id" });
    a.d(c, "_4", function() { return "wait-open" });
    ...
    (function(a) {
        (function() {
            function b() { this.end = this.start = 0;
            ...
            function c(a) {
                ...
                for (var C = e, T = 0, f = c.length; T < f; T++)
                    if ("{" ===
                        c[T]) { C.rules || (C.rules = []); var h = C,
                            n = h.rules[h.rules.length - 1] || null;
                        C = new b;
                        C.start = T + 1;
                        C.parent = h;
                        C.previous = n;
                        h.rules.push(C) } else "}" === c[T] && (C.end = T + 1, C = C.parent || e);
                return g(e, a)
            }
            ...
            function l(a, b, c) {
                ...
                if (a.cssText || a.rules) {
                    ...
                    if (p) {
                        p = 0;
                        for (var e = d.length, wa; p < e && (wa = d[p]); p++) g =
                            l(wa, b, g)
            ...
            function t(a, b) { if (!a) return ""; "string" === typeof a && (a = c(a));
                b && w(a, b); return l(a, F) }
            ...
            function w(a, b, c, d) { if (a) { var g = !1,
                        p = a.type; if (d && p === mb) { var e = a.selector.match(bb);
                        e && (window.matchMedia(e[1]).matches || (g = !0)) }
                    p === ob ? b(a) : c && p === Pa ? c(a) : p === nb && (g = !0); if ((a = a.rules) && !g) { g = 0;
                        p = a.length; for (var B; g < p && (B = a[g]); g++) w(B, b, c, d) } } }

            function P(a, b, c, d) { var g = document.createElement("style");
            ...
            function q(a, b) { var g = a.indexOf("var("); if (-1 === g) return b(a, "", "", "");
                a: { var c = 0; var d = g + 3; for (var p = a.length; d < p; d++)
                        if ("(" === a[d]) c++;
                        else if (")" === a[d] && 0 === --c) break a;d = -1 }
                c = a.substring(g + 4, d);
                g = a.substring(0, g);
                a = q(a.substring(d + 1), b);
                d = c.indexOf(","); return -1 === d ? b(g, c.trim(), "", a) : b(g, c.substring(0, d).trim(), c.substring(d + 1).trim(), a) }
            ...
            function D(a) { var b = a.localName,
                    g = "";
                b ? -1 < b.indexOf("-") || (g = b, b = a.getAttribute && a.getAttribute("is") || "") : (b = a.is, g = a.extends); return { is: b, u: g } }

            function M() {}

            function N(a, b, c) { var g = H;
                a.__styleScoped ? a.__styleScoped = null : pa(g, a, b || "", c) }

            function pa(a, b, c, d) { b.nodeType === Node.ELEMENT_NODE && qa(b, c, d); if (b = "template" === b.localName ? (b.content || b.O || b).childNodes : b.children || b.childNodes)
            ...
            function qa(a, b, c) {
                if (b)
                    ...
                    else if (a.getAttribute) { var g = a.getAttribute(za);
                    c ? g && (b = g.replace("style-scope", "").replace(b, ""), L(a, b)) : L(a, (g ? g + " " : "") + "style-scope " + b) }
            }

            function ea(a, b, c) { var g = H,
                    d = a.__cssBuild;
                x || "shady" === d ? b = t(b, c) : (a = D(a), b = J(g, b, a.is, a.u, c) + "\n\n"); return b.trim() }

            function J(a, b, c, d, e) { var g = Aa(c, d);
                c = c ? U + c : ""; return t(b, function(b) { b.c || (b.selector = b.g = V(a, b, a.b, c, g), b.c = !0);
                    e && e(b, c, g) }) }
            ...
            function Ra(a, b) { a = a.split(aa);
                a[0] += b; return a.join(aa) }
            ...
            function E(a, b, c, d) { this.j = a || null;
                this.b = b || null;
                this.A = c || [];
                this.o = null;
                this.u = d || "";
            ...
            function Ta(a) { var b = {},
                ...
                w(a, function(a) { ia(a);
                    a.index = d++;
                    a = a.f.cssText; for (var c; c = Ia.exec(a);) { var g = c[1]; ":" !== c[2] && (b[g] = !0) } }, function(a) { c.push(a) });
                a.b = c;
                a = []; for (var g in b) a.push(g); return a }
            ...
            function ja(a, b) { var c = a.f; if (c) { if (c.i) return Object.assign(b, c.i), !0 } else { c = a.parsedCssText; for (var d; a = sa.exec(c);) { d = (a[2] || a[3]).trim(); if ("inherit" !== d || "unset" !== d) b[a[1].trim()] = d;
                        d = !0 } return d } }

            function ba(a, b, c) { b && (b = 0 <= b.indexOf(";") ? ta(a, b, c) : q(b, function(b, d, g, e) { if (!d) return b + e;
                    (d = ba(a, c[d], c)) && "initial" !== d ? "apply-shim-inherit" === d && (d = "inherit") : d = ba(a, c[g] || g, c) || g; return b + (d || "") + e })); return b && b.trim() || "" }

            function ta(a, b, c) {
                b = b.split(";");
                for (var d = 0, g, e; d < b.length; d++)
                    if (g =
                        b[d]) { I.lastIndex = 0; if (e = I.exec(g)) g = ba(a, c[e[1]], c);
                        else if (e = g.indexOf(":"), -1 !== e) { var p = g.substring(e);
                            p = p.trim();
                            p = ba(a, p, c) || p;
                            g = g.substring(0, e) + p }
            ...
            function Ja(a, b) { var c = {},
                    d = [];
                w(a, function(a) { a.f || ia(a); var g = a.g || a.parsedSelector;
                    b && a.f.i && g && Ga.call(b, g) && (ja(a, c), a = a.index, g = parseInt(a / 32, 10), d[g] = (d[g] || 0) | 1 << a % 32) }, null, !0); return { i: c, key: d } }
            ...
            function ua(a, b) { var c = {},
                    d = {},
                    g = b && b.__cssBuild;
                w(b, function(b) { Ua(a, b, g, function(g) { Ga.call(a.P || a, g.K) && (g.I ? ja(b, c) : ja(b, d)) }) }, null, !0); return { J: d, H: c } }
            ...
            function eb(a, b, c, d) {
                ...
                return ea(b, g, function(b) {
                    ...
                    if (!(x || b.parent && b.parent.type === Pa) && b.cssText) {
                        ...
                        if (b.B)
                            if (null == b.v) { b.v = []; for (var h in p) n = p[h], n = n(g), g !== n && (g = n, b.v.push(h)) } else { for (h = 0; h < b.v.length; ++h) n = p[b.v[h]], g = n(g);
                                n = g }
                        b.cssText = n;
                        b.g = b.g || b.selector;
                        g = "." + d;
            ...
            function fb(a, b) { a = a.b; var c = {}; if (!x && a)
                    for (var d = 0, g = a[d]; d < a.length; g = a[++d]) { var e = g,
                            f = b;
            ...
            function jb(a) {
                ...
                a.b || (a.b = !0, Ya.then(function() { a._applyShimCurrentVersion = a._applyShimNextVersion;
                    a.b = !1 }))
            }

            function r() { this.w = {};
                this.c = document.documentElement; var a = new b;
                a.rules = [];
                a = new E(a);
            ...
            function La(a) {!a.a && window.ShadyCSS && window.ShadyCSS.ApplyShim && (a.a = window.ShadyCSS.ApplyShim, a.a.invalidCallback = la);
                vb(a) }

            function Za(a, b) { return (b = b.getRootNode().host) ? Q(b) ? b : Za(a, b) : a.c }

            function qb(a, b, c) { a = Za(a, b); var d = Q(a);
                a = Object.create(d.m || null); var g = ua(b, c.j);
                b = Ja(d.j, b).i;
                Object.assign(a, g.H, b, g.J);
                b = c.o; for (var e in b)
                    if ((g = b[e]) || 0 === g) a[e] = g;
                e = ka;
                b = Object.getOwnPropertyNames(a); for (g = 0; g < b.length; g++) d = b[g], a[d] = ba(e, a[d], a);
                c.m = a }
            var rb = "undefined" !=
            ...
            if (na && !x) { var Na = na.define;
                na.define = function(a, b, c) { var d = document.createComment(" Shady DOM styles for " + a + " "),
                        g = document.head;
                    g.insertBefore(d, (R ? R.nextSibling : null) || g.firstChild);
                    R = d;
                    ma[a] = d;
                    Na.call(na, a, b, c) } }
            Va.prototype.store = function(a, b, c, d) { var g = this.cache[a] || [];
            ...
            if (!x) {
                ...
                else { var va = function() { W(document.body) };
                    window.HTMLImports ? window.HTMLImports.whenReady(va) : requestAnimationFrame(function() { if ("loading" === document.readyState) { var a = function() { va();
                                document.removeEventListener("readystatechange", a) };
                            document.addEventListener("readystatechange", a) } else va() }) }
            ...
            G.prepareTemplate = function(a,
                b, c) { this.prepareTemplateDom(a, b);
            ...
            G.prepareTemplateStyles = function(a, b, d) {
                if (!a.s) {
                    ...
                    a.extends = d;
                    ca[b] = a;
                    for (var e = (e = a.content.querySelector("style")) ? e.getAttribute("css-build") || "" : "", g = [], f = a.content.querySelectorAll("style"), h = 0; h < f.length; h++) { var k = f[h]; if (k.hasAttribute("shady-unscoped")) { if (!x) { var n = k.textContent;
                                $a.has(n) || ($a.add(n), n = k.cloneNode(!0), document.head.appendChild(n));
                                k.parentNode.removeChild(k) } } else g.push(k.textContent), k.parentNode.removeChild(k) }
                    g =
                        g.join("").trim();
            ...
            G.flushCustomStyles = function() {
                ...
                if (this.b) {
                    ...
                    if (this.b.enqueued) {
                        if (F)
                            for (var c = 0; c <
                                b.length; c++) { if ((a = this.b.getStyleForCustomStyle(b[c])) && F && this.a) { var d = v(a);
                                    La(this);
                                    this.a.transformRules(d);
                                    a.textContent = t(d) } } else
            ...
            G.styleElement = function(a, b) {
                ...
                if (!d) { var e = D(a);
                    d = e.is;
                    e = e.u; var g = ma[d]; if (d = ca[d]) { var f = d._styleAst; var h = d.l }
                    f = new E(f, g, h, e);
                    d = a.__styleInfo = f }
                a !== this.c && (this.s = !0);
                b && (d.o = d.o || {}, Object.assign(d.o, b));
                if (F) { if (d.o) { b = d.o; for (var n in b) null === n ? a.style.removeProperty(n) : a.style.setProperty(n, b[n]) } if (((n = ca[c]) || a === this.c) && n && n.a && n._applyShimCurrentVersion !== n._applyShimNextVersion) { if (n._applyShimCurrentVersion === n._applyShimNextVersion || n._applyShimValidatingVersion !== n._applyShimNextVersion) La(this), this.a && this.a.transformRules(n._styleAst, c), n.a.textContent = ea(a, d.j), jb(n);
                        x && (c = a.shadowRoot) && (c.querySelector("style").textContent = ea(a, d.j));
                        d.j = n._styleAst } } else if (this.flush(),
                    qb(this, a, d), d.A && d.A.length) {
                    c = d;
                    n = D(a).is;
                    a: { if (b = X.cache[n])
                            for (f = b.length - 1; 0 <= f; f--) { h = b[f];
                                b: { d = c.A; for (e = 0; e < d.length; e++)
            ...
            G.C = function(a) { var b = this,
                    c = v(a);
                w(c, function(a) { if (x) ":root" === a.selector && (a.selector = "html");
                    else { var c = H;
                        a.selector = a.parsedSelector; ":root" === a.selector && (a.selector = "html");
            ...
            G.L = function(a, b) { var c = a.getRootNode();
                b = b ? b.split(/\s/) : [];
                c = c.host && c.host.localName; if (!c) { var d = a.getAttribute("class"); if (d) { d = d.split(/\s/); for (var e = 0; e < d.length; e++)
            ...
            window.ShadyCSS = {
                ScopingShim: A,
                prepareTemplate: function(a, b, c) { A.flushCustomStyles();
                    A.prepareTemplate(a, b, c) },
                prepareTemplateDom: function(a, b) { A.prepareTemplateDom(a, b) },
                prepareTemplateStyles: function(a, b, c) { A.flushCustomStyles();
                ...
                styleElement: function(a) { A.flushCustomStyles();
                    A.styleElement(a) },
                styleDocument: function(a) { A.flushCustomStyles();
                    A.styleDocument(a) },
    ...
    d.prototype.processResponse = function(a) {
        ...
        Object(k.g)(b);
        Object(k.d)(Object(f.d)(), e.X, { response: JSON.parse(a) });
        this.constructResponseForRendering(a, Object(f.a)())
    };
    d.prototype.constructResponseForRendering = function(a, b) { var c = this;
        a = a ? JSON.parse(a) : null;!a && a.queryResult.fulfillmentMessages && 0 == a.queryResult.fullfillmentMessages.length || a.queryResult.fulfillmentMessages.forEach(function(a) { a && (c.checkForTextResponseAndRender_(a), c.checkForRichElementsAndRender_(a)) }) };
    ...
    d.prototype.checkForRichElementsAndRender_ = function(a) { var b = this;
        this.responseContainsRichContent_(a) && a.payload.richContent.forEach(function(a) { var c = a.filter(function(a) { return "chips" !== a.type }).map(function(a) { return b.constructItemPayload(a) }).filter(function(a) { return void 0 != a && null != a });
    ...
    d.prototype.constructCustomCard_ = function(a) { if (0 == a.length) return null; var b = new m.a;
        b.classList.add("bot-animation");
        b.elements = a; return { element: b, isBot: !0, type: "customCard" } };
    d.prototype.constructItemPayload =
        function(a) { switch (a.type) {
                case "info":
    ...
    d.prototype.constructTitlePayload_ = function(a) { var b = new u.a;
        b.title = a.title ? a.title : "";
        b.subtitle = a.subtitle ? a.subtitle : "";
        b.imageData = a.image ? a.image : null;
        b.actionLink = a.actionLink ? a.actionLink : ""; return { type: "info", isBot: !0, element: b } };
    d.prototype.constructDescPayload_ = function(a) { var b = new t.a;
        b.title = a.title ? a.title : "";
        b.text = a.text ? a.text : null; return { type: "description", isBot: !0, element: b } };
    ...
    d.prototype.constructTextResponse_ = function(a, b) { a.forEach(function(a) { if (a) { var c = Object.assign({}, h.c);
                a = Object(k.c)("div", ["message", "bot-message", "bot-animation"], a);
                c.isBot = !0;
                c.type = "text";
                c.element = a;
                b.newMessage(c) } }) };
    d.prototype.constructButtonPayload_ = function(a) { var b = new l.a;
        b.text = a.text;
        b.link = a.link;
        b.iconColor = a.icon.color;
        b.iconType = a.icon.type;
        b.event = a.event; return { type: "button", isBot: !0, element: b } };
    d.prototype.constructListPayload_ = function(a) { var b = new P.a;
        b.title = a.title ? a.title : "";
        b.subtitle = a.subtitle ? a.subtitle : "";
        b.imageData = a.image ? a.image : null;
        b.event = a.event ? a.event : null; return { type: "list", isBot: !0, element: b } };
    d.prototype.constructAccordionPayload_ = function(a) { var c = new b.a;
        c.title = a.title;
        c.subtitle = a.subtitle;
        c.image = a.image;
        c.text = a.text; return { type: "accordion", isBot: !0, element: c } };
    ...
    function e(a, b, c) { if (!c.requestBody) return c.userId && (a = f(c, a)), a; switch (b) {
            case "text":
            ...
            case "event":
                ...
                d = h(c, d); break;
            default:
                console.error('DfMessenger: Invalid input type "' + b + '"') } return d }

    function f(a,
        b) { b.queryParams ? b.queryParams.payload || (b.queryParams.payload = {}) : b.queryParams = { payload: {} };
        b.queryParams.payload.userId = a.userId; return b }

    function h(a, b) { var c = b && b.queryInput && (b.queryInput.text || b.queryInput.event) ? !0 : !1;
        c ? a.userId && (b = f(a, b)) : (console.error("DfMessenger: Please return a valid request body."), b = null); return b }
    c.b = function(a, c, d) {
        var f = e(a, c, d);
        return new Promise(function(a, c) {
            var e = new XMLHttpRequest,
                h = "";
            h = d.getAttribute(m.d) ? d.apiUri + "/" + d.projectId + "/sessions/" + d.sessionId :
                d.apiUri + "/" + d.projectId + "/agent/sessions/" + d.sessionId + ":detectIntent";
            e.open("POST", h, !0);
            e.setRequestHeader("Content-type", "application/json");
            null !== d.accessToken && "undefined" !== typeof d.accessToken && e.setRequestHeader("Authorization", "Bearer " + d.accessToken);
            f ? (Object(l.a)().newMessage(Object(l.a)().botWriting()), e.send(JSON.stringify(f)), Object(k.d)(d, m.W, { requestBody: f })) : (h = Object.assign({}, t.b), h.error.message = "Please specify query input (text or event)", b(h), c(h));
    ...
    c.a = function(a) { var b = Object.assign({}, t.d);
        b.queryInput.text.text = a || "";
        b.queryInput.text.languageCode = Object(l.d)().languageCode; return b };
    var k = a(1),
        l = a(2),
        m = a(0),
        t = a(4)
    ...
    d = new Map([
        ...
        ["zh-HK", { askSomething: "\u8acb\u8f38\u5165\u60a8\u7684\u554f\u984c", chatTitle: "\u5373\u6642\u901a\u8a0a", errorMessage: "\u767c\u751f\u932f\u8aa4\uff0c\u8acb\u518d\u8a66\u4e00\u6b21", messageTooLong: "\u5f88\u62b1\u6b49\uff0c\u60a8\u7684\u8a0a\u606f\u8d85\u51fa\u4e86 numOfChars \u500b\u5b57\u5143\u3002" }],
        ...
        ["nl", { askSomething: "Vraag iets...", chatTitle: "Chat", errorMessage: "Er is iets misgegaan. Probeer het opnieuw.", messageTooLong: "Uw bericht is numOfChars tekens te lang." }],
    ...
    a.prototype.connectedCallback = function() { ShadyCSS.styleElement(this);
        this.attachShadow({ mode: "open" }).appendChild(h.content.cloneNode(!0));
        this.render();
        this.listenForCardClick_() };
    a.prototype.render = function() { this.createOuterElement_();
    ...
    a.prototype.createContentWrapperElement_ = function() { if (this.title || this.subtitle || this.imageData) return Object(e.c)("div", [b._1]) };
    a.prototype.createImageElement_ = function() { if (this.imageData && this.imageData.src && this.imageData.src.rawUrl) { var a = Object(e.c)("div", ["image"], null, { style: 'background-image: url("' + this.imageData.src.rawUrl + '")' });
            Object(e.a)("." + b._1, this.shadowRoot).appendChild(a) } };
    a.prototype.createTitleElement_ =
        function() { if (this.title) { this.createTextContainer_(); var a = Object(e.c)("div", ["title"], this.title);
                Object(e.a)(".text-container", this.shadowRoot).appendChild(a) } };
    a.prototype.createSubtitleElement_ = function() { if (this.subtitle) { this.textContainerExists_() || this.createTextContainer_(); var a = Object(e.c)("div", ["subtitle"], this.subtitle);
            Object(e.a)(".text-container", this.shadowRoot).appendChild(a) } };
    ...
    a.prototype.createTextContainer_ =
        function() { Object(e.a)("." + b._1, this.shadowRoot).appendChild(Object(e.c)("div", ["text-container"])) };
    a.prototype.createLinkWrapper_ = function() { return Object(e.c)("a", [b.Q], "", { href: this.actionLink, target: "_blank" }) };
    a.prototype.wrapCardWithLinkWrapper_ = function() { var a = this.createContentWrapperElement_(),
    ...
    a.prototype.connectedCallback = function() {
        ...
        var c = Object(m.c)("link", [], null, { href: "https://fonts.googleapis.com/icon?family=Material+Icons", rel: "stylesheet" }),
            d = Object(m.c)("link", [], null, { href: "https://fonts.googleapis.com/css?family=Roboto", rel: "stylesheet" });
        document.head.appendChild(c);
        document.head.appendChild(d);
        setTimeout(function() { Object(m.d)(a, b.E, {}) })
    };
    a.prototype.attributeChangedCallback = function(a, c, d) { switch (a) {
            case b.L:
                this.expandChanged_(d) } };
    a.prototype.showMinChat =
        function() { return this.addMinChatView_() };
    ...
    a.prototype.addMinChatView_ = function() { Object(e.b)().classList.add(b.j);
    ...
    a.prototype.missingAttributes_ = function() {
        ...
        this.apiUri ||
            (this.getAttribute(b.d) ? this.apiUri = "https://dialogflow.cloud.google.com/v1/integrations/messenger/webhook" : this.apiUri = "https://dialogflow.googleapis.com/v2/projects");
        return a
    };
    a.prototype.toggleExpandAttribute_ = function() { this.hasAttribute(b.L) ? this.removeAttribute(b.L) : this.setAttribute(b.L, "") };
            ...
            function d(d, k) {
                for (;;) switch (e) {
                    ...
                    case 1:
                        ...
                        throw k;
                    case 2:
                        f = h = d, void 0 !== a && null !== a ? (c.chatIsMinimized_() ? Object(m.d)(c, t.k, {}) : (Object(m.a)("#" + b.p, f).classList.add("rotate-fade"), Object(m.a)("." + b.u, f).classList.add("hidden"), v || null === c.waitOpen || null === c.intent || c.initializeDFMessenger_(), Object(m.d)(c, b.l, {})), c.showChat_(), Object(m.a)(".df-messenger-wrapper", c.shadowRoot).classList.add("expanded")) : (Object(m.a)("#" + b.p, f).classList.remove("rotate-fade"), Object(m.a)("." + b.u, f).classList.remove("hidden"), c.hideChat_(),
                            Object(m.d)(c, t.h, {}), Object(m.a)(".df-messenger-wrapper", c.shadowRoot).classList.remove("expanded")), e = -1;
                    default:
    ...
    a.prototype.payloadForTesting = function(a) { switch (a) {
            case "info":
    ...
    a.prototype.handleFailedRequests_ = function() {
        var a = this;
        this.addEventListener(b.D,
            function() { var c = Object(e.c)().shadowRoot,
                    d = Object(m.a)("." + b.K, c);
                d.innerHTML = Object(m.e)(a.languageCode, "errorMessage");
                d.classList.add(b.Z);
                setTimeout(function() { d.classList.remove(b.Z);
                    a.stopBotTyping_() }, 5E3) })
    };
    a.prototype.stopBotTyping_ = function() { var a = Object(m.a)("#" + b.f, Object(e.c)().shadowRoot);
        a && Object(m.g)(a) };
    ...
    a.prototype.performButtonClickActions_ = function() {
        ...
        this.shadowRoot.querySelector("button").addEventListener("click",
            function() { a.toggleExpandAttribute_() })
    };
    a.prototype.sendEvent = function(a) { a.queryInput && a.queryInput.event ? Object(k.b)(a, b.N.event, this).then(function(a) {
            (new h.a).processResponse(a) }, function(a) { console.error("DfMessenger Request failed ", a.error.code + ": " + a.error.message) }) : console.error("DfMessenger: Please enter a valid query input for the event") };
    a.prototype.setChatIcon_ = function(a) { if (a) { var c = Object(m.c)("img", [b.u]);
            Object(m.f)(this, a, c, this.onLoad, this.onError) } else this.setDefaultIcon_() };
    a.prototype.onLoad = function(a, b, c) { b.src = c;
    ...
    $jscomp.global.Object.defineProperties(a.prototype, {
        apiUri: {
            ...
            get: function() { return this.getAttribute(b.e) }
        },
        projectId: { configurable: !0, enumerable: !0, set: function(a) { a && this.setAttribute(b.V, a) }, get: function() { return this.getAttribute(b.d) ? this.getAttribute(b.d) : this.getAttribute(b.V) } },
        languageCode: { configurable: !0, enumerable: !0, set: function(a) { a && this.setAttribute(b.P, a) }, get: function() { return this.getAttribute(b.P) } },
        sessionId: { configurable: !0, enumerable: !0, set: function(a) { a && this.setAttribute(b.Y, a) }, get: function() { return this.getAttribute(b.Y) } },
        expand: { configurable: !0, enumerable: !0, set: function(a) { a && this.setAttribute(b.L, a) }, get: function() { return this.getAttribute(b.L) } },
        ...
        intent: { configurable: !0, enumerable: !0, set: function(a) { a && this.setAttribute(b.O, a) }, get: function() { return this.getAttribute(b.O) } },
        chatIcon: { configurable: !0, enumerable: !0, set: function(a) { a && this.setAttribute(b.i, a) }, get: function() { return this.getAttribute(b.i) } },
        chatTitle: { configurable: !0, enumerable: !0, set: function(a) { a && this.setAttribute(b.m, a) }, get: function() { return this.getAttribute(b.m) } },
        userId: { configurable: !0, enumerable: !0, set: function(a) { a && this.setAttribute(b._2, a) }, get: function() { return this.getAttribute(b._2) } },
        waitOpen: { configurable: !0, enumerable: !0, get: function() { return this.getAttribute(b._4) }, set: function(a) { a && this.setAttribute(b._4, a) } }
    });
    $jscomp.global.Object.defineProperties(a, { observedAttributes: { configurable: !0, enumerable: !0, get: function() { return [b.L] } } });
    ...
    a = function() { return HTMLElement.call(this) || this };
    $jscomp.inherits(a, HTMLElement);
    a.prototype.connectedCallback = function() { ShadyCSS.styleElement(this); var a = this.attachShadow({ mode: "open" });
...
}, function(d, c) { c = function() { return this }(); try { c = c || Function("return this")() || (0, eval)("this") } catch (a) { "object" === typeof window && (c = window) }
    d.exports = c }, function(d, c, a) {
    var b = a(1),
        e = a(2),
        f = a(0);
    d = a(3);
    ...
    a.prototype.connectedCallback = function() { ShadyCSS.styleElement(this);
        ...
        Object(b.a)("#" + f.U, this.shadowRoot).addEventListener("click", function() { Object(e.d)().removeAttribute(f.L) }) };
    ...
    a.prototype.handleKeyPress_ = function(a) { var b = Object(l.a)("input", this.shadowRoot).value.length;
    ...
    a.prototype.sendMessage_ = function() {
        ...
        a.value && (Object(l.a)(".input-box-wrapper", this.shadowRoot).classList.remove("valid"), Object(b.a)().newMessage(this.buildMessageForDisplay_(a.value)),
            Object(l.d)(Object(b.d)(), k._3, { input: a.value }), this.makeRequest_(a.value), a.value = "", a.focus())
    };
    a.prototype.makeRequest_ = function(a) { var b = Object(l.a)(k.B);
        Object(h.b)(Object(h.a)(a), k.N.text, b).then(function(a) {
            (new f.a).processResponse(a) }, function(a) { console.error("DfMessenger: Request failed", a.error.code + ": " + a.error.message) }) };
    ...
    d.prototype.connectedCallback = function() { var a = this,
    ...
    (function(a, c) { d.exports = c() })(this, function() {
        ...
        function h(a, b) { v && v(a, null); for (var c = b.length; c--;) { var d = b[c]; if ("string" === typeof d) { var e = V(d);
                    e !== d && (w(b) || (b[c] = e), d = e) }
                a[d] = !0 } return a }

        function k(a) { var b = {},
                c = void 0; for (c in a) D(t, a, [c]) && (b[c] = a[c]); return b }
        ...
        function m() {
            ...
            var c = a.document,
                ...
                Qa = a.DOMParser;
            q = a.trustedTypes;
            if ("function" === typeof a.HTMLTemplateElement) { var xa = f.createElement("template");
            ...
            var Ia = eb,
                ...
                Y = function(a,
                    c) { try { J(b.removed, { attribute: c.getAttributeNode(a), from: c }) } catch (wb) { J(b.removed, { attribute: null, from: c }) }
                    c.removeAttribute(a) },
                g = function(a) {
                    var b = void 0,
                        c = void 0;
                    ...
                    e && h(Z, ["title"]);
                    if (!b || !b.documentElement) { b = oa.createHTMLDocument(""); var n = b.body;
            ...
            if (b.isSupported) { try { g('<svg><p><textarea><img src="</textarea><img src=x abc=1//">').querySelector("svg img") && (d = !0) } catch (n) {}(function() { try { var a = g("<x/><title>&lt;/title&gt;&lt;img&gt;");
                        E(/<\/title/, a.querySelector("title").innerHTML) && (e = !0) } catch (gb) {} })() }
            var p = function(a) { return x.call(a.ownerDocument || a, a, w.SHOW_ELEMENT | w.SHOW_COMMENT | w.SHOW_TEXT, function() { return w.FILTER_ACCEPT }, !1) },
                ...
                C = function(a) {
                    ...
                    if (!y[c] || Z[c]) { if (Na && !va[c] && "function" === typeof a.insertAdjacentHTML) try { var d = a.innerHTML;
                            a.insertAdjacentHTML("AfterEnd", K ? K.createHTML(d) : d) } catch (xb) {}
                        S(a); return !0 }
                ...
                lb = function(a) {
                    ...
                    if (e) {
                        ...
                        for (d = e.length; d--;) {
                            ...
                            c = g.attrValue;
                            if (!g.forceKeepAttr) {
                                if ("name" === k && "IMG" === a.nodeName && e.id) { var J = e.id;
                                    e = Aa(e, []);
                                    Y("id", a);
                                    Y(h, a);
                                    pa(e, J) > d && a.setAttribute("id", J.value) } else if ("INPUT" !== a.nodeName || "type" !== k || "file" !== c || !g.keepAttr || !z[k] && ha[k]) "id" === h && a.setAttribute(h, ""), Y(h, a);
                                else continue;
                                if (g.keepAttr)
                                    if (Da && E(/\/>/i, c)) Y(h, a);
                ...
                ub = function gb(a) { var b, c = p(a); for (B("beforeSanitizeShadowDOM", a, null); b = c.nextNode();) B("uponSanitizeShadowNode", b, null), C(b) || (b.content instanceof t && gb(b.content), lb(b));
            ...
            b.sanitize = function(d, e) {
                ...
                if (H) { if (Ma)
                    ...
                    ka && (d = sa.call(c, d, !0)); return d }
                f = aa ? f.outerHTML : f.innerHTML;
                U && (f = O(f, Ia, " "), f = O(f, Ka, " "));
                return K && ma ? K.createHTML(f) : f
            };
            b.setConfig = function(a) { A(a);
                za = !0 };
            b.clearConfig = function() { X = null;
                za = !1 };
            b.isValidAttribute =
                function(a, b, c) { X || A({});
                    a = V(a);
                    b = V(b); return T(a, b, c) };
        ...
        var la = "function" === typeof Symbol && "symbol" ===
            typeof Symbol.iterator ? function(a) { return typeof a } : function(a) { $jscomp.initSymbol();
                $jscomp.initSymbol();
                $jscomp.initSymbol(); return a && "function" === typeof Symbol && a.constructor === Symbol && a !== Symbol.prototype ? "symbol" : typeof a },
            jb = function(a, b) {
    ...
    d.prototype.render = function() { this.setTextAndLink_();
        this.setIcon_() };
    ...
    d.prototype.setIcon_ = function() { Object(f.a)(".df-button-icon #materialIcon", this.shadowRoot).style.color = this.iconColor;
    ...
    a.prototype.connectedCallback = function() { ShadyCSS.styleElement(this);
        ...
        this.render_() };
    a.prototype.render_ = function() { var a = this;
    ...
    a.prototype.createOuterElement_ = function() { if (this.title || this.text) { var a = Object(e.c)("div");
            a.id = b.q;
            this.shadowRoot.appendChild(a) } };
    a.prototype.createTitleElement_ = function() { if (this.title) { var a = Object(e.c)("div", ["title"], this.title);
            Object(e.a)("#" + b.q, this.shadowRoot).appendChild(a) } };
    a.prototype.createTextElement_ = function() { var a = this;
        this.text && this.text.forEach(function(c) { c = Object(e.c)("div", ["description-line"], c);
    ...
    a.prototype.onLoad =
        function(a, b, c) { b.setAttribute("src", c);
    ...
    a.prototype.onListElementClick_ = function() {
        var a = this;
        Object(k.d)(Object(e.d)(), b.R, { element: this });
        var c = {};
    ...
    a.prototype.makeRequest = function(a) { return Object(f.b)(a, b.N.event, Object(e.d)()) };
    ...
    d = function() { return HTMLElement.call(this) || this };
    $jscomp.inherits(d, HTMLElement);
    d.prototype.connectedCallback = function() { this.attachShadow({ mode: "open" }).appendChild(m.content.cloneNode(!0));
    ...
    d.prototype.onClick_ = function() { var a = this,
            c = Object(e.b)("." + b.o + " > a", this.shadowRoot);
        c && c.length && c.forEach(function(c) { c.addEventListener("click", function() { Object(e.d)(Object(f.d)(), b._0, { query: c.textContent });
    ...
    d.prototype.sendChipTextAsRequest_ = function(a) { a && Object(k.b)(a, b.N.text, Object(f.d)()).then(function(a) {
            (new l.a).processResponse(a) }, function(a) { console.error("DfMessenger Request failed ", a.error.code + ": " + a.error.message) }) };
    d.prototype.addToMessageList_ = function(a) { var b = Object.assign({}, h.c);
        b.type = "text";
        b.isBot = !1;
    ...
    function a(a, c) { var b = a[1] || "",
            d = a[3]; return d ? c && "function" === typeof btoa ? (a = "/*# sourceMappingURL=data:application/json;charset=utf-8;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(d)))) + " */", c = d.sources.map(function(a) { return "/*# sourceURL=" + d.sourceRoot + a + " */" }), [b].concat(c).concat([a]).join("\n")) : "" + b : b }
    d.exports = function(b) {
        ...
        c.i = function(a,
            b) { "string" === typeof a && (a = [
                [null, a, ""]
            ]); for (var d = {}, e = 0; e < this.length; e++) { var f = this[e][0]; "number" === typeof f && (d[f] = !0) } for (e = 0; e < a.length; e++) f = a[e], "number" === typeof f[0] && d[f[0]] || (b && !f[2] ? f[2] = b : b && (f[2] = "(" + f[2] + ") and (" + b + ")"), c.push(f)) };
        return c
    }
}, function(d, c, a) {
    function b(a, b) {
    ...
    function e(a, b) { for (var c = [], d = {}, e = 0; e < a.length; e++) { var f = a[e],
                h = b.base ? f[0] + b.base : f[0];
            f = { css: f[1], media: f[2], sourceMap: f[3] };
            d[h] ? d[h].parts.push(f) : c.push(d[h] = { id: h, parts: [f] }) } return c }
    ...
    function k(a) { var b = document.createElement("style");
        a.attrs.type = "text/css";
        m(b, a.attrs);
        f(a, b); return b }

    function l(a) { var b = document.createElement("link");
        a.attrs.type = "text/css";
    ...
    function t(a, b) {
        ...
        if (b.singleton) {
            ...
            var f =
                v.bind(null, d, c, !0)
        } else a.sourceMap && "function" === typeof URL && "function" === typeof URL.createObjectURL && "function" === typeof URL.revokeObjectURL && "function" === typeof Blob && "function" === typeof btoa ? (d = l(b), e = P.bind(null, d, b), f = function() { h(d);
            d.href && URL.revokeObjectURL(d.href) }) : (d = k(b), e = w.bind(null, d), f = function() { h(d) });
        e(a);
    ...
    function w(a, b) { var c = b.css;
        (b = b.media) && a.setAttribute("media", b); if (a.styleSheet) a.styleSheet.cssText = c;
    ...
    d.exports = function(a, c) {
        ...
        var d = e(a, c);
        b(d, c);
        return function(a) { for (var f, h = [], k = 0; k < d.length; k++) f = u[d[k].id], f.refs--, h.push(f);
            a && (f = e(a, c), b(f, c)); for (k = 0; k < h.length; k++)
                if (f = h[k], 0 === f.refs) { for (a = 0; a < f.parts.length; a++) f.parts[a]();
                    delete u[f.id] } }
    };
    ...
    d.exports = function(a) {
        ...
        return a.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(a, b) { b = b.trim().replace(/^"(.*)"$/, function(a, b) { return b }).replace(/^'(.*)'$/, function(a, b) { return b }); if (/^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(b)) return a;
            a = 0 === b.indexOf("//") ? b : 0 === b.indexOf("/") ? c + b : d + b.replace(/^\.\//, ""); return "url(" + JSON.stringify(a) + ")" })
    }
}]);